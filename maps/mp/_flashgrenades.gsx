...
monitorFlash()
{
	...
	while(1)
	{
		...
		print ("-- rumble --\n");
		print ("-- rumble --\n");
		self stopLocalSound("flashbang_tinnitus_loop");
		self stopLocalSound("flashbang_tinnitus_loop_silent");
		self stopLoopSound("flashbang_tinnitus_loop");
		self stopLoopSound("flashbang_tinnitus_loop_silent");
		self playLoopSound("flashbang_tinnitus_abort");
		self playLoopSound("flashbang_tinnitus_end");
		self playLocalSound("flashbang_tinnitus_abort");
		self playLocalSound("flashbang_tinnitus_end");
		*/
