...
onOvertime()
{
	...
	for ( index = 0; index < level.players.size; index++ )
	{
		...
		level.players[index] thread scripts\menus::_show_hint_msg("Sudden Death!",0,3,320,50,0,0,"left","middle",0,0,"objective",3.6,3.6,(1,1,1),1,(1,0.3,0.2),1,1,true,undefined,true);
