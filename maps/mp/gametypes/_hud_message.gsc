...
showNotifyMessage( notifyData )
{
	...
	if ( isDefined( notifyData.titleText ) )
	{
		...
		else
		{
			...
			self.notifyTitle setPulseFX( 50, int(duration*1000), 1000 );
			self.notifyTitle.glowColor = glowColor;	
			self.notifyTitle.alpha = 1;
			//self _show_hint_msg(notifyData.titleText,1,2,200,100,0,0,"left","middle",0,0,"default",1.6,1.6,(1,1,0),1,(1,1,0),1,1);
		}
	}
	...
	if ( isDefined( notifyData.notifyText ) )
	{
		...
		else
		{
			...
			self.notifyText setPulseFX( 50, int(duration*1000), 1000 );
	...
	if ( isDefined( notifyData.notifyText2 ) )
	{
		...
		else
		{
			...
			self.notifyText2 setPulseFX( 50, int(duration*1000), 1000 );
...
teamOutcomeNotify( winner, isRound, endReasonText )
{
	...
	leftScore setPulseFX( 50, duration, 1000 );
	...
	rightScore setPulseFX( 50, duration, 1000 );
...
outcomeNotify( winner, endReasonText )
{
	...
	if ( isDefined( players[0] ) )
	{
		...
		firstTitle setPulseFX( 50, duration, 1000 );
	}
	...
	if ( isDefined( players[1] ) )
	{
		...
		secondTitle setPulseFX( 50, duration, 1000 );
	}
	...
	if ( isDefined( players[2] ) )
	{
		...
		thirdTitle setPulseFX( 50, duration, 1000 );
	}
